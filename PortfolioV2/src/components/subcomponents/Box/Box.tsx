...
export interface IBox {
  ...
  /** Box height */
  boxHeight?: string;
  /** Hide right content (image, socials) */
  hideRight?: boolean;
  /** Hide left content (title, icon, bullet points, description, tags) */
  hideLeft?: boolean;
...
function Box({
  ...
  return (
    <div
      className={`box-wrapper ${hideHoverEffects ? "hide-hover-effects" : ""}`}
    ...
    >
      <div className="box" style={{ height: boxHeight }}>
          ...
          <div className="box-left">
            <div className="title">
              ...
              {titleAddition && (
                <>
                  <p>&nbsp;•&nbsp;&nbsp;</p>
                  <p className="gradient-text boldest">{titleAddition}</p>
                </>
              )}
            </div>
            {description && (
        ...
        {!hideRight && showImage ? (
          <>
            {imageTitleText ? (
              <h3 className="img-title-text gradient-text">{imageTitleText}</h3>
            ) : (
              <></>
            )}
            <div
            ...
            >
              ...
              {/* <div className="img-light-shadow"></div> */}
            </div>
          </>
        ) : (
          <></>
        )}
        {!hideRight && !showImage && showIcon ? (
          <img className="box-icon" src={`icons/${iconName}`}></img>
        ) : (
          <></>
        )}
        {!hideRight && !showImage && !showIcon && showSocials && (
          <div className="socials-box">
            ...
            <p>
              <a href="https://www.instagram.com/andrew._lai/" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
